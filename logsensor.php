      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item  menu-open">
            <a href="logsensor.php" class="nav-link  active">
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Log Sensor</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
              ...
              <table class="table">
                ...
                <?php
                    ...
                    if(!isset($_GET['halaman'])){
                      ...
                      $sql_k = "SELECT * FROM sensor_suhu";
                      if (!empty($katakunci_kategori)){
                        $sql_k .= " where `tanggal` LIKE '%$katakunci_kategori%' ";
                      }
                      $sql_k .= " ORDER BY `id` DESC limit $posisi, $batas ";
